...
import AerospaceDisplayManager from "./components/settings/aerospace-display-manager.jsx";
...
export const data = {
  ...
  yabaiPath: {
    label: "yabai path",
    type: "text",
    placeholder: "default: $(which yabai)",
    fullWidth: true,
    title: "Configuration",
  },
  aerospacePath: {
    ...
    type: "text",
    placeholder: "default: $(which aerospace)",
    fullWidth: true,
  },
  windowManager: {
  ...
  customAeroSpaceDisplayIndexes: {
    label: "<em>AeroSpace</em> Custom AeroSpace display indexes",
    type: "component",
    Component: AerospaceDisplayManager,
  },
  ...
  memoryWidget: { label: "Memory", type: "checkbox" },
   ...
   diskUsageWidget: { label: "Disk usage", type: "checkbox" },
  ...
  memoryMonitorApp: {
   ...
   diskUsageWidgetOptions: {
     label: "Disk usage",
     documentation: "/disk-usage/",
     infos: [
       "Displays disk usage for the root partition (/) only.",
       "Here you can set the refresh frequency of the widget.",
       "The default value is set to 30000 ms (30 seconds).",
     ],
   },
